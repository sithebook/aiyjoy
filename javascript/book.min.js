...
BookType.slide_book||bookType==BookType.singleSlide_book)b="slidesound";var c=soundBaseURL+b+".mp3";b=soundBaseURL+b+".ogg";bookConfig.flipSoundURL&&(b=c=bookConfig.flipSoundURL);c=$("<audio preload style='display:none;'>\n        \"<source src='"+c+"?2024070101' type='audio/ogg'>\n        \"<source src='"+b+"?2024070101' type='audio/mpeg'>\n        </audio>");$("body").append(c);b=parseFloat(bookConfig.bgSoundVol/100);c[0].volume=b;c.bind("ended",function(){$(this).remove()});try{c[0].currentTime=
0,c[0].play()}catch(d){}}else if(!isPlaying||!isAndroidDefault())try{flipAudio[0].currentTime=0,flipAudio[0].play()}catch(d){}},initFlipSound=function(){if(isPhone()||isPad()||isIE()){var b="flipsound";if(bookType==BookType.slide_book||bookType==BookType.singleSlide_book)b="slidesound";var c=soundBaseURL+b+".mp3";b=soundBaseURL+b+".ogg";bookConfig.flipSoundURL&&(b=c=bookConfig.flipSoundURL);flipAudio=$("<audio preload id='flipSound'>\n      <source src='"+c+"?2024070101' type='audio/ogg'>\n      <source src='"+
b+"?2024070101' type='audio/mpeg'>\n      </audio>");$("body").append(flipAudio)}};function copyFromObj(b){if(b){b.focus();b.select();try{document.execCommand("Copy")}catch(c){b=b.val(),copyToClipboard(b)}}}
...
(tmpBookConfig.bookResourceBaseURL=tmpBookConfig.bookBaseURL);tmpBookConfig.enableCustomizedBookmarkWidth=getConfigValue("enableCustomizedBookmarkWidth",!1);tmpBookConfig.customizedBookmarkWidth=getConfigValue("customizedBookmarkWidth",50);tmpBookConfig.onlyOpenInDingDing=getConfigValue("onlyOpenInDingDing",!1);tmpBookConfig.disableDingDingSharing=getConfigValue("disableDingDingSharing",!1);tmpBookConfig.formBackgroundOpacity=getConfigValue("formBackgroundOpacity",1);tmpBookConfig.phoneToolbarFontSize=
getConfigValue("phoneToolbarFontSize","small").toLowerCase();tmpBookConfig.EnableRecognizeQRcodePressOnMobile=getConfigValue("EnableRecognizeQRcodePressOnMobile",!1);tmpBookConfig.mobileThumbnailSearchBarVisible=getConfigValue("mobileThumbnailSearchBarVisible",!0);tmpBookConfig.loadingMainColor=getConfigValue("loadingMainColor","#1F2232");tmpBookConfig.loadingBackgroundColorType=getConfigValue("loadingBackgroundColorType","1");tmpBookConfig.isShowFirstOrLastPagePrompt=getConfigValue("isShowFirstOrLastPagePrompt",
!0);tmpBookConfig.isShowMobileBottomFullscreenPrompts=getConfigValue("isShowMobileBottomFullscreenPrompts",!1);tmpBookConfig.SmallProgramUrl=getConfigValue("SmallProgramUrl","");tmpBookConfig.searchColor=getConfigValue("searchColor","#00ffff");tmpBookConfig.searchAlpha=getConfigValue("searchAlpha",.3);tmpBookConfig.appLogoIcon=getConfigValue("appLogoIcon","");tmpBookConfig.HomeURL=getConfigValue("HomeURL","");tmpBookConfig.bookTitle=getConfigValue("bookTitle","FLIPBOOK");tmpBookConfig.bookDescription=
getConfigValue("bookDescription","");tmpBookConfig.toolbarColor=getConfigValue("toolbarColor","#27181A");tmpBookConfig.iconColor=getConfigValue("iconColor","#FFFFFF");tmpBookConfig.toolbarColor==tmpBookConfig.iconColor&&(tmpBookConfig.iconColor=Color(tmpBookConfig.toolbarColor).reverse());tmpBookConfig.pageNumColor=getConfigValue("pageNumColor","#000000");tmpBookConfig.formBackgroundColor=getConfigValue("formBackgroundColor",tmpBookConfig.toolbarColor);tmpBookConfig.formFontColor=getConfigValue("formFontColor",
tmpBookConfig.iconColor);tmpBookConfig.formBackgroundColor.toLocaleLowerCase()==tmpBookConfig.formFontColor.toLocaleLowerCase()&&(tmpBookConfig.formFontColor=Color(tmpBookConfig.formBackgroundColor).reverse());tmpBookConfig.loadingBackground=getConfigValue("loadingBackground","#1F2232");tmpBookConfig.loadingDisplayTime=getConfigValue("loadingDisplayTime",0);tmpBookConfig.searchHightlightColor=getConfigValue("searchHightlightColor","#fdc606");tmpBookConfig.logoHeight=getConfigValue("logoHeight",40);
tmpBookConfig.logoTop=getConfigValue("logoTop",0);tmpBookConfig.logoPadding=getConfigValue("logoPadding",0);tmpBookConfig.isFixLogoSize=getConfigValue("isFixLogoSize",!1);tmpBookConfig.HomeButtonVisible=getConfigValue("HomeButtonVisible",!1);tmpBookConfig.ShareButtonVisible=getConfigValue("ShareButtonVisible",!1);tmpBookConfig.facebookAppId=getConfigValue("facebookAppId","");tmpBookConfig.isInsertFrameLinkEnable=getConfigValue("isInsertFrameLinkEnable",!0);tmpBookConfig.addCurrentPage=getConfigValue("addCurrentPage",
!1);tmpBookConfig.DoubleSinglePageButtonVisible=getConfigValue("DoubleSinglePageButtonVisible",!1);tmpBookConfig.ToolBarVisible=getConfigValue("ToolBarVisible",!0);tmpBookConfig.WeChatShareButtonVisible=getConfigValue("WeChatShareButtonVisible",!1);tmpBookConfig.ThumbnailsButtonVisible=getConfigValue("ThumbnailsButtonVisible",!1);tmpBookConfig.thumbnailColor=getConfigValue("thumbnailColor",tmpBookConfig.formBackgroundColor);tmpBookConfig.thumbnailAlpha=getConfigValue("thumbnailAlpha",100);tmpBookConfig.ThumbnailSize=
...
void 0==window.htmlConfig.downloadconfig.length||(window.downloadconfig=window.htmlConfig.downloadConfig)};checkHtmlConfig();
...
try{console&&console.error&&console.error.apply(console,arguments)}catch(b){}this.logForPad(String.format.apply(this,arguments),"red")}},print:function(){var b=String.format.apply(this,arguments),c=(new Date).format("hh:mm:ss.S");this.debug("[%s] %s",c,b)}}}),VERSION_NAME="6.4.9",BUILD_DATE="2024072401",BookType={normal_book:0,single_book:1,slide_book:3,singleSlide_book:6,catalog_book:7,singleCatalog_book:8},normalBookStatu={book_statu_ready:0,book_statu_auto_flip:1,book_statu_mouse_flip:2,book_statu_mag_flip:3},
...
plugins:[b]})}resizePlugin()}},addSlideShow:function(){if(isPhone()||"English"!=UserGroups){var b=parseInt(_get(global,"staticAd.adPosition",1));if(window.staticAd&&window.staticAd.haveAd&&0<window.staticAd.data.length&&[1,2,3].includes(b)){this.slideShow=$("<div class='slideShow' style='position:absolute;z-index:1002;'></div>");switch(b){case 1:this.slideShow.css({bottom:"0px",width:"100%"});break;case 2:this.slideShow.css({top:"22px",width:"100%"});break;case 3:b=parseInt(_get(global,"staticAd.top",
50));var c=parseInt(_get(global,"staticAd.left",50)),d=parseInt(_get(global,"staticAd.width",50)),e=parseInt(_get(global,"staticAd.height",50));this.slideShow.css({top:b+"%",left:c+"%",width:d+"%",height:e+"%"})}b=window.staticAd.bgColor?window.staticAd.bgColor:"#fff";c=window.staticAd.bgOpacity?window.staticAd.bgOpacity:0;b=(new Color(b)).rgba(c);this.slideShow.css("background",b);window.staticAd.bgColor||this.slideShow.css("z-index","auto");window.addSlideShow=new SliderShowAd(this.slideShow,window.staticAd)}}},
addDynamicBackground:function(){if(bookConfig.backgroundScene&&"None"!=bookConfig.backgroundScene&&!isBelowIE9()){var b=$("<div></div>");b.css({width:"100%",height:"100%",position:"absolute","z-index":2});this.bg.append(b);DynamicBackground.create({name:bookConfig.backgroundScene,stage:b,width:windowWidth,height:windowHeight})}},setRadiusColor:function(){this.gColorA===this.gColorB?this.bgColor.css({background:this.gColorA}):this.bgColor.css({"background-image":_agent_.browser.prefix+"linear-gradient("+
this.gAngle+"deg, "+this.gColorA+", "+this.gColorB+")"})}});
...
f=d;"string"==typeof d&&(f=[d]);if(f&&0!=f.length){var g=[];for(d=0;d<f.length;d++){var h=toAbsURL(f[d]);g.push(h)}d=BookRestrict.getRestrictToken();$.ajax({type:"get",url:restrictUrl,dataType:"json",data:{urls:JSON.stringify(g),token:d},success:function(k){if("OK"==k.code){for(var l=!0,n=0;n<f.length;n++){var p=g[n];accessControlImagesPool[f[n]]=k.data[p];k.data[p]||(l=!1)}e.completedTask(b,c);l&&e.completedAllTask(b,c)}else window.encryptionPannel&&!window.encryptionPannel.visible&&window.encryptionPannel.show()},
error:function(){window.encryptionPannel&&!window.encryptionPannel.visible&&window.encryptionPannel.show()}})}else this.completedTask(b,c)},isCompleted:function(b,c){b=parseInt((b-1)/this.pageLength);return this.taskList[c]&&this.taskList[c][b]&&this.taskList[c][b].completed?!0:!1},completedTask:function(b,c){try{this.taskList[c][b].completed=!0,this.taskList[c][b].running=!1}catch(d){}},completedAllTask:function(b,c){try{this.taskList[c][b].completedAll=!0}catch(d){}},getUrls:function(b){if("object"==
typeof b){for(var c=[],d=[],e=0;e<b.length;e++){var f=b[e],g=f.removeStartFrom("?");f=f.remove(g);f=f.remove("?");d.push(f)}for(e=0;e<b.length;e++)f=b[e],g=f.removeStartFrom("?"),0<=f.indexOf("none")?c.push("none"):c.push(accessControlImagesPool[g]?this.mergeParamFromUrl(accessControlImagesPool[g],d[e]):f);return c}if(0<=b.indexOf("none"))return"none";g=b.removeStartFrom("?");f=b.remove(g);f=f.remove("?");return accessControlImagesPool[g]?this.mergeParamFromUrl(accessControlImagesPool[g],f):accessControlImagesPool[g]?
this.mergeParamFromUrl(accessControlImagesPool[g],f):b},mergeParamFromUrl:function(b,c){return b},removeParamFromUrl:function(b){if("object"==typeof b){for(var c=[],d=0;d<b.length;d++){var e=b[d],f=e.removeStartFrom("?");0>e.indexOf("none")&&!accessControlImagesPool[f]&&c.push(f)}return c}if(0<=b.indexOf("none"))return[];c=[];f=b.removeStartFrom("?");c.push(f.toString());return accessControlImagesPool[f]?[]:c}}}),adjustPageURL=function(b,c,d){b=parseInt(b)-1;global.fliphtml5_pages||(global.fliphtml5_pages=
[]);global.fliphtml5_pages[b]||(global.fliphtml5_pages[b]={});switch(c){case 0:global.fliphtml5_pages[b].l=d;break;case 1:global.fliphtml5_pages[b].n=d;break;case 2:global.fliphtml5_pages[b].t=d;break;case 3:global.fliphtml5_pages[b].p=d}},useTheFliphtml5Service=function(){if(bookConfig.useTheFliphtml5Service)for(var b=bookConfig.totalPageCount,c=1;c<=b;c++){var d=pageDirWidthPath(c,"normal",b),e=pageDirWidthPath(c,"large",b),f=pageDirWidthPath(c,"thumb",b),g=pageDirWidthPath(c,"previewPage",b);if("string"!=
typeof d)for(var h=0;h<d.length;h++)d[h]=resetFliphtml5URL(d[h]);else d=resetFliphtml5URL(d);e=resetFliphtml5URL(e);f=resetFliphtml5URL(f);g=resetFliphtml5URL(g);adjustPageURL(c,0,e);adjustPageURL(c,1,d);adjustPageURL(c,2,f);adjustPageURL(c,3,g)}},useTheAliCloudChart=function(b,c){if(bookConfig.useTheAliCloudChart){if(isPad()||isPhone())try{b*=devicePixelRatio,c*=devicePixelRatio}catch(n){}for(var d=bookConfig.totalPageCount,e=1;e<=d;e++){var f=realPageDir(e,"normal",d),g=realPageDir(e,"large",d),
h=realPageDir(e,"thumb",d),k=realPageDir(e,"previewPage",d);if("string"!=typeof f)for(var l=0;l<f.length;l++)f[l]=resetYunzhanURL(f[l],b,c);else f=resetYunzhanURL(f,b,c);g=resetYunzhanURL(g);h=resetYunzhanURL(h);k=resetYunzhanURL(k);adjustPageURL(e,0,g);adjustPageURL(e,1,f);adjustPageURL(e,2,h);adjustPageURL(e,3,k)}}};
...
this.upMask.setLeftOrRight(rightToLeft);this.downMask.setLeftOrRight(rightToLeft);this.book.setZIndexByPageIndex(this.upMask);this.book.setZIndexByPageIndex(this.downMask);this.upMask.clearFlipShadow();this.downMask.clearFlipShadow()}}).extend(FlipPage),SingleCalendarPage=Class({flipToPoint:function(b,c,d){if(b&&c)if(1==this.hardPage)this.flipToHardPoint(b,c);else if(this.downMask&&this.upMask&&this.downMask.page&&this.upMask.page){this.coordinate=c;var e=this.pageWidth,f=computePoint(this.pageHeight,
e,this.maskWidth,b,c);if(f){var g=transformCSS({rotate:f.rotate,tran:{x:-f.maskTranY,y:f.maskTranX}}),h=transformCSS({rotate:f.rotate,tran:{x:-f.maskTranY,y:f.maskTranX}}),k=transformCSS({rotate:-f.rotate,tran:{x:0,y:-f.pageTranX}}),l=transformCSS({rotate:f.rotate,tran:{x:0,y:f.pageTranX}});this.downMask&&this.downMask.setCSSByStyle(g);this.upMask&&this.upMask.setCSSByStyle(h);this.downMask&&this.downMask.page&&this.downMask.page.setCSSByStyle(k);this.upMask&&this.upMask.page&&this.upMask.page.setCSSByStyle(l);
this.setFlipAlpha(e,b,c);this.setFlipShadow(f,d);this.book.followToPoint(this,b,c)}}},flipToHardPoint:function(b,c){if(b&&c){this.coordinate=c;var d=this.pageWidth,e=computePoint(this.pageHeight,d,this.maskWidth,b,c);if(e){var f=-90+90*Math.abs(c.x/b.x);0>c.x&&(f=90-90*Math.abs(c.x/b.x));var g=transformCSS({perspective:6E3,rotateX:-f});f=transformCSS({perspective:6E3,rotateX:-f});this.downMask&&this.downMask.setCSSByStyle(g);this.upMask&&this.upMask.setCSSByStyle(f);0>c.x/b.x?(this.upMask.setVisible(!1),
...
25,"Sine");p++}.interval(this,l/25)}.bind(this):function(){k=function(p,v){n(p,v,"Sine")}.animation(this,l)}.bind(this);var n=function(p,v,B){if(!b)return!1;var t=b.pageWidth,u=b.pageHeight,w=$.easing["easeInOut"+B],x=$.easing["easeOut"+B];B=x(null,p,g,b.toPoint.x-g,v);x=x(null,p,h,b.toPoint.y-h,v);b.dragMoveToFlip||(B=w(null,p,g,b.toPoint.x-g,v),x=bookConfig.FlipDirection?f*Math.sqrt(u*u-B*B):u-f*Math.sqrt(t*t-B*B));p<v?this.flipToPoint(b,c,d,b.fromPoint,{x:B,y:x}):(this.flipToPoint(b,c,d,b.fromPoint,
